...
-- Open new buffer in a new window
keymap("n", "<C-s>", ":w!<CR>", { desc = "Save a file" })

-- Save File
keymap("i", "<C-s>", "<ESC>:w!<CR>", { desc = "Save a file" })
keymap("n", "<C-n>", ":vne <CR>", { desc = "New Vertical" })
keymap("n", "<leader>r", ":SidebarNvimToggle <CR>", { desc = "Toggle Right Sidebar" })
keymap("n", "<A-g>", ":NeatermLazygit <CR>", { desc = "LazyGit" })
